...
class ResPartnerTicket(models.Model):
    ...
    new_support_ticket_count = fields.Integer(compute="_count_new_support_tickets", string="Nuevo Ticket Count")
    support_ticket_string = fields.Char(compute="_compute_support_ticket_string", string="Cadena de tickets de soporte")
    sla_id = fields.Many2one('website.support.sla', string="SLA")
    dedicated_support_user_id = fields.Many2one('res.users', string="Usuario de soporte dedicado")
